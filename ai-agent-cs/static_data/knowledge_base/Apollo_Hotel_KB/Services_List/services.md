...
topic: Apollo Hotel Services & Amenities
version: 2.0
last_updated: 2026-03-23
---

# Apollo Hotel Services

## Overview
This document lists the official services and amenities provided by Apollo Hotel. 

## 1. Breakfast Service
* **Hours**: A rich breakfast buffet is served daily from **6:30 AM to 10:30 AM**.
* **Offerings**: The buffet includes Continental, Italian, Full English/Irish, and Vegetarian options.
* **Special Dietary Needs**: Lactose-free options and gluten-free baskets can be provided upon request (an additional fee may apply depending on the booking).
* **Early Departures**: Guests leaving before breakfast hours can request an **early breakfast box** the day before.
...
* Secure luggage storage is available for guests before check-in or after check-out.

## 4. Concierge & Transfer Services
